//Hacemos que el menu se esconda si presiono en otra parte de la pagina
...
(function (global){
    ...
    document.addEventListener("DOMContentLoaded", function (event) {
        // TODO: STEP 0: Look over the code from below
    ...
    function buildAndShowHomeHTML (categories) {
        ...
        $ajaxUtils.sendGetRequest(homeHtmlUrl, function (home) {
            ...
            var homeHtmlToInsertIntoMainPage = insertProperty(home,"randomCategoryShortName",chosenCategoryShortName);
...
//ESTO HAY QUE ARREGLARRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR
            if (i % 2 != 0){
